...
The **HeavyLasso** package implements robust linear regression with heavy-tailed errors modeled by a Student-\eqn{t} distribution. It uses an EM-like algorithm with \eqn{\ell_1} penalization (lasso) for variable selection and robustness against outliers.
